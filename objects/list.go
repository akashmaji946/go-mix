...
var listMethods = []*Builtin{
	{
		Name:     "list", // Creates a new mutable list from arguments
		Callback: listFunc,
	},
	{
		Name:     "pushback_list", // Appends an element to the end of a list
		Callback: pushbackList,
	},
	{
		Name:     "pushfront_list", // Prepends an element to the start of a list
		Callback: pushfrontList,
	},
	{
		Name:     "popback_list", // Removes and returns the last element of a list
		Callback: popbackList,
	},
	{
		Name:     "popfront_list", // Removes and returns the first element of a list
		Callback: popfrontList,
	},
	{
		Name:     "size_list", // Returns the number of elements in a list
		Callback: sizeList,
	},
	{
		Name:     "peekback_list", // Returns the last element without removing it
		Callback: peekbackList,
	},
	{
		Name:     "peekfront_list", // Returns the first element without removing it
		Callback: peekfrontList,
	},
	{
		Name:     "insert_list", // Inserts an element at a specific index
		Callback: insertList,
	},
	{
		Name:     "remove_list", // Removes an element at a specific index
		Callback: removeList,
	},
	{
		Name:     "contains_list", // Checks if a value exists in the list
		Callback: containsList,
	},
}
