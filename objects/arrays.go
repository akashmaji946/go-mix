...
var arrayMethods = []*Builtin{
	{
		Name:     "push", // Adds an element to the end of the array
		Callback: push,
	},
	{
		Name:     "pop", // Removes and returns the last element of the array
		Callback: pop,
	},
	{
		Name:     "shift", // Removes and returns the first element of the array
		Callback: shift,
	},
	{
		Name:     "unshift", // Adds an element to the beginning of the array
		Callback: unshift,
	},
}
...
// The function modifies the array in place and returns a new array with the element appended.
...
// The function modifies the array in place by shortening its elements slice.
...
// It takes one argument: the array to modify.
// If the array is empty or arguments are invalid, it returns an error.
// The function modifies the array in place by slicing from the second element onward.
...
// If the arguments are invalid, it returns an error object.
// The function creates a new array with the element prepended and returns it.
