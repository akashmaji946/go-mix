...
var setMethods = []*Builtin{
	{
		Name:     "insert_set", // Inserts a value into a set
		Callback: setInsert,
	},
	{
		Name:     "remove_set", // Removes a value from a set
		Callback: setRemove,
	},
	{
		Name:     "contains_set", // Checks if a set contains a value
		Callback: setContains,
	},
	{
		Name:     "values_set", // Returns an array of all values in a set
		Callback: setValues,
	},
}
