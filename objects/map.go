...
var mapMethods = []*Builtin{
	{
		Name:     "keys_map", // Returns an array of all keys in a map
		Callback: mapKeys,
	},
	{
		Name:     "insert_map", // Inserts or updates a key-value pair in a map
		Callback: mapInsert,
	},
	{
		Name:     "remove_map", // Removes a key-value pair from a map
		Callback: mapRemove,
	},
	{
		Name:     "contain_map", // Checks if a map contains a key
		Callback: mapContain,
	},
	{
		Name:     "enumerate_map", // Returns array of [key, value] pairs
		Callback: mapEnumerate,
	},
}
